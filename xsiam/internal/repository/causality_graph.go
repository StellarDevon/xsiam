...
type CausalityGraphRepo struct {
	db arangodb.Database
}

func NewCausalityGraphRepo(db arangodb.Database) *CausalityGraphRepo {
	return &CausalityGraphRepo{db: db}
}

func (r *CausalityGraphRepo) GetGraphByIncident(ctx context.Context, incidentID string) (*model.CausalityGraph, error) {
...
func (r *CausalityGraphRepo) Upsert(ctx context.Context, graph *model.CausalityGraph) error {
